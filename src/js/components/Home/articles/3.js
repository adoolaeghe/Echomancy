...
export default class Article3 extends React.Component {
  ...
  componentDidMount() {
		...
		sr.reveal('.article3-dot', {delay: 200});
  }
      ...
      >
        ...
        <div className="acticle3-text-content col m12 l7">
          <div className={`article3-header ${this.state.animation ? "animation" : ""}`}>
            ...
            <a className="article3-header-link">How do I earn from my discoveries ?</a>
          </div>
        </div>
        <div className="article3-dot dot-left" />
        <div className="article3-dot dot-right" />
      </section>
    );
  }
}
